...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | Peminjaman Kendaraan</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'User'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/user/index.php">User / Peminjam</a>
                </li>
                ...
                <?php if($title_web == 'Konfirmasi'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/booking/booking.php">Daftar Peminjam</a>
                </li>
