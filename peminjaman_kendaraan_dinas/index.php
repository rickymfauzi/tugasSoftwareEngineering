                ...
                <div class="card-body">
                    <?php if($_SESSION['USER']){?>
                        ...
                        <center>
                            ...
                            <?php }else{?>
                                <a href="blog.php" class="btn btn-primary mb-2 btn-block">Pinjam Kendaraan Sekarang !</a>
                            <?php }?>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <img src="assets/image/<?php echo $isi['gambar'];?>" class="card-img-top" style="height:200px;">
                        ...
                        <div class="card-body">
                        <center><a href="booking.php?id=<?php echo $isi['id_mobil'];?>" class="btn btn-success">Pinjam Sekarang!</a>
